...
> **Experimental — not production ready.** foobarjs is under active development (v0.5.4). APIs, conventions, and database schemas may change between releases without a migration path. Use it for prototyping, learning, and side projects. Do not deploy to production yet.
